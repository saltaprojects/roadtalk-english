...
export const dialogueTexts: DialogueText[] = [
  ...
  },
  {
    ...
    keyVocabulary: ["truck stop", "nearest", "far", "which way"],
    keyVocabularyTranslation: ["стоянка для грузовиков", "ближайший", "далеко", "куда"],
  },
  {
    id: 'dlg-beg-3',
    ...
    keyVocabulary: ["fill up", "diesel", "pump", "restroom", "pay"],
    keyVocabularyTranslation: ["заправить", "дизель", "колонка", "туалет", "оплатить"],
  },
  {
    id: 'dlg-beg-4',
    ...
    keyVocabulary: ["check in", "reservation", "parking", "checkout"],
    keyVocabularyTranslation: ["зарегистрироваться", "бронирование", "парковка", "выезд"],
  },
  ...
  // Intermediate Level Dialogues
  {
    ...
    keyVocabulary: ["delivery", "bill of lading", "back up", "unload", "inspection"],
    keyVocabularyTranslation: ["доставка", "коносамент", "подъехать задом", "разгрузить", "проверка"],
  },
  {
    id: 'dlg-int-2',
    ...
    keyVocabulary: ["behind schedule", "heavy traffic", "location", "assignment", "delivery time"],
    keyVocabularyTranslation: ["опаздываю", "плотное движение", "местоположение", "задание", "время доставки"],
  },
  {
    id: 'dlg-int-3',
    ...
    keyVocabulary: ["driver's license", "registration", "logbook", "cargo documents"],
    keyVocabularyTranslation: ["водительские права", "регистрация", "книжка учёта", "документы на груз"],
  },
  {
    id: 'dlg-int-4',
    ...
    keyVocabulary: ["engine", "strange noise", "check engine light", "inspection", "serious"],
    keyVocabularyTranslation: ["двигатель", "странный шум", "лампа проверки двигателя", "проверка", "серьёзное"],
  },
  {
    id: 'dlg-int-5',
    ...
    keyVocabulary: ["cargo", "damaged", "paperwork", "documented"],
    keyVocabularyTranslation: ["груз", "повреждены", "документы", "задокументировано"],
  },
  ...
  // Advanced Level Dialogues
  {
    ...
    keyVocabulary: ["customs declaration", "manifest", "sealed", "estimated value"],
    keyVocabularyTranslation: ["таможенная декларация", "манифест", "опечатан", "оценочная стоимость"],
  },
  {
    id: 'dlg-adv-2',
    ...
    keyVocabulary: ["logbook", "rest periods", "gross vehicle weight", "DOT inspection"],
    keyVocabularyTranslation: ["книжка учёта", "периоды отдыха", "полная масса", "проверка DOT"],
  },
  {
    id: 'dlg-adv-3',
    ...
    keyVocabulary: ["accident report", "dash cam footage", "insurance", "incident"],
    keyVocabularyTranslation: ["отчёт о происшествии", "запись с видеорегистратора", "страховка", "инцидент"],
  },
  {
    id: 'dlg-adv-4',
    ...
    keyVocabulary: ["rate", "fuel prices", "detention pay", "layover compensation"],
    keyVocabularyTranslation: ["ставка", "цены на топливо", "оплата за простой", "компенсация за задержку"],
  },
  {
    id: 'dlg-beg-5',
    ...
    keyVocabulary: ["pre-trip inspection", "headlights", "tires", "brakes", "fluids"],
    keyVocabularyTranslation: ["предрейсовый осмотр", "фары", "шины", "тормоза", "жидкости"],
  },
  {
    id: 'dlg-beg-6',
    ...
    keyVocabulary: ["mandatory rest break", "rest area", "logbook", "well-rested", "alert"],
    keyVocabularyTranslation: ["обязательный перерыв", "место отдыха", "книжка учёта", "отдохнувший", "внимательный"],
  },
  {
    id: 'dlg-int-6',
    ...
    keyVocabulary: ["heavy snow", "visibility", "icy roads", "safety", "delayed"],
    keyVocabularyTranslation: ["сильный снег", "видимость", "обледенелые дороги", "безопасность", "задержано"],
  },
  {
    id: 'dlg-int-7',
    title: 'Tire Problem',
    ...
    keyVocabulary: ["roadside assistance", "flat tire", "hazard lights", "shoulder"],
    keyVocabularyTranslation: ["помощь на дороге", "спущенная шина", "аварийные огни", "обочина"],
  },
  {
    id: 'dlg-int-8',
    ...
    keyVocabulary: ["parking spots", "overnight", "hours of service", "truck-friendly"],
    keyVocabularyTranslation: ["места для парковки", "ночная", "часы работы", "приспособленный для грузовиков"],
  },
  {
    id: 'dlg-adv-5',
    ...
    keyVocabulary: ["load securement", "straps", "weight distribution", "tie-down points", "height restrictions"],
    keyVocabularyTranslation: ["крепление груза", "ремни", "распределение веса", "точки крепления", "ограничения по высоте"],
  },
  {
    id: 'dlg-adv-6',
    ...
    keyVocabulary: ["alternate route", "construction delays", "low clearance bridge", "on-time delivery"],
    keyVocabularyTranslation: ["альтернативный маршрут", "задержки из-за строительства", "мост с низким просветом", "доставка вовремя"],
  },
];
